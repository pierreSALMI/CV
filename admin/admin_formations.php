...
<head>
    ...
    <?php include '../pdo.php'; ?>
    <?php 
        $req = $pdo->prepare('SELECT * FROM info_perso'); 
        $req->execute();
                        ...
                        <div class="form-group">                    
                            <div class="row mt-3">
                                <div class="col-md-auto text-center">
                                    ...
                                    <input type="text" class="form-control" id="note" placeholder="note" value="<?=$key['diplome'] ?>">
                                </div>
                                <div class="col mt-3">
                                    <textarea class="form-control" id="Description" rows="3"><?=$key['description'] ?></textarea> 
                                </div>
                            </div>
                            <button type="submit" name="<?=$key['id']?>" class="btn btn-primary m-2">Modifier</button>
