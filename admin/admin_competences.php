    ...
    <header>
        ...
        <div class="container-fluid" style="height: 920px">
            <div class="row h-100">
                ...
                <div class="col pt-3">
                    <button type="ajouter" class="btn btn-primary">Ajouter</button>
                    <?php 
                    ...
                    <div class="row mt-5"> 
                        ...
                        <form class="form-group" action="admin_envoie2.php" method="post">
                        
                            <input type="text" class="form-control" id="note" name="competence-<?=$key['id']?>" placeholder="note" value="<?=$key['note']?>">
