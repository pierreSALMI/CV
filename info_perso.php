...
<header>
    ...
    <div class="container-fluid mt-3">
        <div class="row">
            <div class="col-2">
                <img src="images/pew_pew_pew.jpg" title=""> 
                    <p>Née le 08/12/2000</p>
                    <p> 3 chemin de ganymede </p>
                    <p>33460 Macau</p>
                    <p>Permis B</p>
                    <p> tel: 0648831522</p>
                    <p> Email: salmipierre@gmail.com</p>
            </div>
            <div class="col mt-4">
                <!-- description -->
                <?php 
                    $req = $pdo->prepare('SELECT * FROM info_perso WHERE id = 1'); 
                    $req->execute();
